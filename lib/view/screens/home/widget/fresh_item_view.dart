...
class FreshItemView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Provider.of<ProductProvider>(context, listen: false).freshItemList !=
            null
        ? Column(children: [
            Padding(
              padding: EdgeInsets.fromLTRB(10, 20, 15, 10),
              child: TitleWidget(
                  title: getTranslated('fresh_items', context),
                  onTap: () {
                    Navigator.pushNamed(
                        context, RouteHelper.getFreshItemRoute());
                  }),
            ),
                                                      ...
                                                      Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Provider.of<ProductProvider>(
                                                                  ...
                                                                  0
                                                              ? Text(
                                                                  '${Provider.of<ProductProvider>(context, listen: false).freshItemList[index].price}.00',
                                                                  style: poppinsRegular.copyWith(
                                                                      fontSize:
                                                                          Dimensions
                                                                              .FONT_SIZE_SMALL,
