...
class Footer extends StatefulWidget {
  ...
  const Footer({Key key, this.categoriesList, this.brandsList}) : super(key: key);
             ...
             tile(
              ...
              topHeading(text: "Top Brands"),
                 ...
                 Container(
                   ...
                   runSpacing: 10.0,
                   direction: Axis.horizontal,
                     children:  List.generate(widget.brandsList.length, (index) => normalText(text: widget.brandsList[index].brandName)),
                   ),
                 ),
              SizedBox(height: 20,),
              Divider(color: Colors.grey.shade300,height: 1,),
              ...
              SizedBox(height: 15,),
              normalText(text: "Akbarimandi makes shopping easier and more convenient than ever."),
              ...
              normalText(text: "GrocerApp is a low-price online supermarket that allows you to order products across categories like grocery, vegetables, beauty & wellness, household care, baby care, pet care and meats & seafood and gets them delivered to your doorstep."),
                ...
                SizedBox(height: 15,),
              normalText(text: "akbarimandionlin@gmail.com, +92-304-1110055 \n "
